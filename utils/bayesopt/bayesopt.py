...
from utils.ml import timed_print as print
from utils.ml.models import GP
from utils.ml.optimization import minimize_with_restarts, sample_then_minimize
    ...
    def run(self):
        ...
        for self.curr_bo_step in range(0, self.n_bo_steps):
            ...
            if True:
                ...
                self._update_surrogate_with_new_data(new_sample_x, new_sample_y)
